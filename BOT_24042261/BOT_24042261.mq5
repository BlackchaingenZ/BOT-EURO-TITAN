...
//========================
input string ControlBotToken = "8331554344:AAFxGw4pS-UqtCwsdolE9hvcSDmz1N4W0E4";
input string ControlChatID   = "@THONGBAOREMOTE";
...
input double Lot1_Default = 0.01;
input double Lot2_Default = 0.02;
input double Lot3_Default = 0.04;
...
{
   EA_PAUSE = true;
   SendControlTelegram("REMOTE: Bot OFF");
}
...
{
   EA_PAUSE = false;
   SendControlTelegram("REMOTE: Bot start");
}
   // CLOSE ALL
   ...
   // LOT PRESETS
   if(StringFind(response,"/lot0.01")>=0)
   {
      Lot1=0.01;
      Lot2=0.02;
      Lot3=0.04;
      SendControlTelegram("REMOTE LOT: 0.01 - 0.02 - 0.04");
   }

   if(StringFind(response,"/lot0.02")>=0)
   {
      Lot1=0.02;
      Lot2=0.04;
      Lot3=0.08;
      SendControlTelegram("REMOTE LOT: 0.02 - 0.04 - 0.08");
   }

   if(StringFind(response,"/lot0.04")>=0)
   {
      Lot1=0.04;
      Lot2=0.08;
      Lot3=0.16;
      SendControlTelegram("REMOTE LOT: 0.04 - 0.08 - 0.16");
   }
      if(StringFind(response,"/lot0.1")>=0)
   {
      Lot1=0.1;
      Lot2=0.2;
      Lot3=0.4;
      ...
      if(StringFind(response,"/lot0.2")>=0)
   {
      Lot1=0.2;
      Lot2=0.4;
      Lot3=0.8;
      ...
      if(StringFind(response,"/lot0.4")>=0)
   {
      Lot1=0.4;
      Lot2=0.8;
      Lot3=1.6;
      ...
      if(StringFind(response,"/lot0.8")>=0)
   {
      Lot1=0.8;
      Lot2=1.6;
      Lot3=3.2;
